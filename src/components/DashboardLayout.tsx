...
function SidebarFooter({
  ...
  return (
    <div className="px-3 pb-6 pt-4 border-t border-slate-200/70 dark:border-slate-800">
      <div
        className={`flex ${!forMobile && collapsed ? "flex-col items-center" : "flex-col"} gap-2`}
      >
...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const adminLinks = [
    ...
    {
      to: "/admin/teachers",
      label: t("adminTeachers"),
      icon: Users,
      end: false,
    },
    {
      to: "/admin/teacher-requests",
      label: t("teacherRequests"),
      icon: UserSquare2,
      end: false,
    },
    {
      to: "/admin/students",
      label: t("adminStudents"),
      icon: GraduationCap,
      end: false,
    },
    {
      to: "/admin/subjects",
      label: t("stagesAndSubjects"),
      icon: BookOpen,
      end: false,
    },
    {
  ...
  const studentLinks = [
    {
      to: "/student",
      label: t("studentOverview"),
      icon: LayoutDashboard,
      end: true,
    },
    {
      to: "/student/learn",
      label: t("studentLearn"),
      icon: LearnIcon,
      end: false,
    },
    {
    ...
    {
      to: "/student/payments-record",
      label: t("paymentsRecord"),
      icon: CreditCard,
      end: false,
    },
  ];
  ...
  return (
    <div
      className={`min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 dashboard-shell ${collapsed ? "collapsed" : ""}`}
    >
          ...
          >
            ...
            <div className="px-4 pt-4 pb-4 relative">
              <div className="flex flex-col items-center">
                <NavLink
                  to={roleHome(normalizedRole)}
                  className="flex flex-col items-center gap-2"
                  onClick={() => setMobileOpen(false)}
                >
                  <img
                    src="/academix-logo.svg"
                    alt={t("brandName")}
                    className="w-10 h-10"
                  />
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="sidebar-wrapper relative hidden lg:block">
          ...
          >
            <motion.span
              animate={{
                rotate: isRTL ? (collapsed ? 0 : 180) : collapsed ? 180 : 0,
              }}
