...
function LessonRow({
  ...
  return (
    <div className="px-6 py-3.5">
      <div className="flex items-center gap-4 hover:bg-violet-50/50 dark:hover:bg-violet-900/10 transition-colors rounded-lg px-2 py-2">
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <span
            className="text-sm font-medium text-slate-700 dark:text-slate-300 truncate cursor-pointer hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
        ...
        {lessonQuiz && (
          <span className="hidden sm:flex items-center gap-1 text-xs text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800/40 px-2 py-1 rounded-full flex-shrink-0">
          ...
          {canEdit && (
            <>
              ...
              <Button
                variant="ghost"
                size="sm"
                className="h-7 w-7 p-0 hover:bg-violet-50 dark:hover:bg-violet-900/20 text-violet-600 dark:text-violet-400"
    ...
    <div className="border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-violet-600 text-white text-sm font-bold flex items-center justify-center">
            {unit.order ?? 0}
          </span>
          ...
          <div className="px-6 py-3 border-t border-slate-100 dark:border-slate-800/50">
            {canEdit && (
              <Button
                variant="ghost"
                size="sm"
                className="text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-900/20 h-8 text-xs font-medium"
            ...
            <div className="space-y-4 py-2">
              {quizLoading ? (
                ...
                <div className="space-y-4">
                  {/* Quiz title bar */}
                  <div className="flex items-center gap-2 p-3 bg-violet-50 dark:bg-violet-900/20 rounded-lg border border-violet-100 dark:border-violet-800/40">
                    <ClipboardList className="w-4 h-4 text-violet-600 flex-shrink-0" />
                    {editingTitle ? (
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button variant="ghost" size="sm" className="text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-900/20 h-7 text-xs font-medium" onClick={openAddQuestion}>
